...
PROJECT_NAME="Beneficiary Claims Data API SSAS"
...
then
  git config --global --add safe.directory "$WORKSPACE_REPO_PATH" # Newer version of git got stricter. This resolves git error 'fatal: detected dubious ownership in repository'
