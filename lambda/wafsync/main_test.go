...
func TestUpdateIpSet_Integration(t *testing.T) {
	if testing.Short() {
	...
	// 	expected []string
	// }{
	// 	{name: "Happy path: 1 new address", expected: []string{"127.0.0.1/32"}},
	// 	{name: "Happy path: 2 new addresses", expected: []string{"127.0.0.1/32", "127.0.0.2/32"}},
	// }
