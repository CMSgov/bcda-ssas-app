...
func (s *APITestSuite) TestCreateV2System() {
	...
	req := httptest.NewRequest("POST", "/v2/system", strings.NewReader(`{"client_name": "Test Client", "group_id": "test-group-id","xdata":"test xdata", "scope": "bcda-api", "public_key": "-----BEGIN PUBLIC KEY-----\\nHwIDAQAB\n-----END PUBLIC KEY-----", "tracking_id": "T00000"}`))
