...
the U.S. government](https://code.gov/)! 

This project is not accepting external contributions at this time. However, feedback and questions are welcome and may be submitted via the [Beneficiary Claims Data API Google Group](https://groups.google.com/forum/#!forum/bc-api).
...
5.  From your branch, make a pull request against `CMSGov/bcda-ssas-app/main`
6.  Work with repo maintainers to get your change reviewed
7.  Wait for your change to be pulled into `CMSGov/bcda-ssas-app/main`
...
bcda-ssas-app will see regular updates and new releases. This section describes the general guidelines around how and when a new release is cut.
...
bcda-ssas-app uses [Semantic Versioning](https://semver.org/). Each release is associated with a [`git tag`](github.com/CMSGov/bcda-ssas-app/tags) of the form `X.Y.Z`.
...
The following steps outline the process to prepare a Release Candidate of bcda-ssas-app. This process makes public the intention and contents of an upcoming release, while allowing work on the next release to continue as usual in `dev`.
...
The following steps describe how to make an approved [Release Candidate](#preparing-a-release-candidate) an official release of bcda-ssas-app:
...
[proj-releases-new]: https://github.com/CMSGov/bcda-ssas-app/releases/new
-->
...
docs. Please file an [issue](https://github.com/CMSGov/bcda-ssas-app/issues).
-->
